...
struct Interaction {
    ...
    Interaction (int _proteina = 0, int _proteinb = 0, double _interaction = 0.0, double _balanced_interaction = 0.0) {
        proteina = _proteina;
        proteinb = _proteinb;
...
void read_proteins(PPI &Current_ppi, string Ppidata_file) {
    ...
    if(!fin.is_open()) {
            cout << "Open PPI_file failed! " << Ppidata_file << endl;
    }
